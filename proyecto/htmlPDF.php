...
$datos = $mostrar->MostrarPreparacionPDF($anioSeleccionado, $mesSeleccionado);
    ...
    <table style="margin-bottom: 50px;">
        <tbody>
            <tr>
                ...
                <td rowspan="4" style="text-align: center;">PREPARACIÓN <?php echo ($mesConvert . ' ' . $anioSeleccionado); ?> </td>
                <td>LBS-PHS-FR-01</td>
